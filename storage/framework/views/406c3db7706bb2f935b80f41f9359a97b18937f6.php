...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo e(URL::to('assets/img/bz-logo.png')); ?>" />
...
<body class="">
    ...
    <header class="fixed bg-white left-0 right-0 top-0 z-10 shadow">
        <div class=" text-gray-800 mx-auto flex justify-between px-20 py-3">
            <a href="#" class="w-36"><img src="<?php echo e(URL::to('assets/img/bz-logo.png')); ?>" alt=""></a>
            <nav class="sm:hidden md:block">
                <a href="<?php echo e(route('home')); ?>" class=" mx-2 hover:text-gray-300 text-base font-sans px-3">Home</a>
                <a href="<?php echo e(route('about')); ?>" class="mx-2 hover:text-gray-300 text-base font-sans px-3">About</a>
                <a href="<?php echo e(route('projects-home')); ?>" class="mx-2 hover:text-gray-300 text-base font-sans px-3">Projects</a>
                <a href="<?php echo e(route('partnership')); ?>" class="mx-2 hover:text-gray-300 text-base font-sans px-3">Partners</a>
                <a href="<?php echo e(route('contact')); ?>" class="mx-2 hover:text-gray-300 text-base font-sans px-3">Contact Us</a>
            </nav>
        </div>
    </header>
    ...
    <footer class="text-center lg:text-left bg-cyan-900 text-white font-sans">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="">
                    <img src="<?php echo e(URL::to('/assets/img/bz-logo.png')); ?>" alt="" class="w-32">
                    <h6
                        class="
              uppercase
              font-semibold
...
<?php /**PATH C:\Users\L\Documents\Projects\Laravel Projects\bz-web-final-laravel-project\resources\views/layouts/default.blade.php ENDPATH**/ ?>