    ...
    <section class="px-20 pb-10">
        <div class="grid grid-cols-3 gap-x-10">
            ...
            <div class="col bg-orange-400 w-full mx-auto p-5 items-center justify-center">
                ...
                <br>
                <img src="<?php echo e(URL::to('/assets/img/slider-3.jpg')); ?>" alt="">
                <br><img src="<?php echo e(URL::to('/assets/img/slider-3.jpg')); ?>" alt="">
            </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\L\Documents\Projects\Laravel Projects\bz-web-final-laravel-project\resources\views/projects/dreams.blade.php ENDPATH**/ ?>