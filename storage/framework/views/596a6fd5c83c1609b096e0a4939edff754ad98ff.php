        ...
        <div class="bg-white-600">
            <div class=" py-10 px-4  text-gray-800 ">
                ...
                <div class="p-5">
                    ...
                    <br>
                    <div class="flex">
                        <img src="<?php echo e(URL::to('/assets/img/partner-1.png')); ?>" alt="">
                    ...
                    <div class="flex">
                        <img src="<?php echo e(URL::to('/assets/img/unicef.png')); ?>" alt="">
                        <div class="grid place-items-center">
                            <div class="">
                    ...
                    <div class="flex">
                        <img src="<?php echo e(URL::to('/assets/img/partner-2.jpg')); ?>" alt="">
                        <div class="grid place-items-center">
                            <div class="">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\L\Documents\Projects\Laravel Projects\bz-web-final-laravel-project\resources\views/partnership.blade.php ENDPATH**/ ?>