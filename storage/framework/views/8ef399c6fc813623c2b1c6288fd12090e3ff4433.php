    ...
    <section class="px-20 pb-10 mt-20">
        <div class="grid grid-cols-3 gap-x-10">
            ...
            <div class="col bg-orange-400 w-full mx-auto p-5 items-center justify-center">
                <img src="<?php echo e(URL::to('/assets/img/slider-3.jpg')); ?>" alt="">
                <br>
            </div>
    ...
    <section class="mt-20">
        <div class="px-20">
            ...
            <div class="w-full items-center px-20">
                <img src="<?php echo e(URL::to('/assets/img/siyakha-model.png')); ?>" alt="" class="w-full">
            </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\L\Documents\Projects\Laravel Projects\bz-web-final-laravel-project\resources\views/projects/siyakha.blade.php ENDPATH**/ ?>