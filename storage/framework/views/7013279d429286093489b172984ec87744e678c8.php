                ...
                <div
                  ...
                  <div class="md:flex md:flex-row">
                    <div
                      ...
                      <img
                        src="<?php echo e(URL::to('/assets/img/BZ-HALF-LOGO.PNG')); ?>"
    ...
    <section>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10 mt-10 px-10">
            ...
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                ...
                <div class="px-3 py-2">
                    <h1 class="font-semibold text-cyan-900 py-2"><a href="<?php echo e(route('projects-dreams')); ?>">DREAMS - CDC</a>
                    </h1>
                    <hr>
                    ...
                    <br>
                    <a href="<?php echo e(route('projects-dreams')); ?>" class="text-cyan-700 hover:font-bold hover:text-cyan-900">Read
                        More ></a>
                </div>
            </div>
            ...
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                ...
                <div class="px-3 py-2">
                    <h1 class="font-semibold text-cyan-900 py-2"><a href="<?php echo e(route('projects-ovc')); ?>">ZINGANE - OVC PROJECT</a></h1>
                    <hr>
                    ...
                    <br>
                    <a href="<?php echo e(route('projects-ovc')); ?>" class="text-cyan-700 hover:font-bold hover:text-cyan-900">Read
                        More ></a>
                </div>
            </div>
            <!-- Project card -->
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                ...
                <div class="px-3 py-2">
                    <h1 class="font-semibold text-cyan-900 py-2"><a href="<?php echo e(route('projects-cp')); ?>">CHILD PROTECTION - UNICEF</a>
                    </h1>
                    <hr>
                    ...
                    <br>
                    <a href="<?php echo e(route('projects-cp')); ?>" class="text-cyan-700 hover:font-bold hover:text-cyan-900">Read More
                        ></a>
                </div>
            </div>
            <!-- Project card -->
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                ...
                <div class="px-3 py-2">
                    <h1 class="font-semibold text-cyan-900 py-2"><a href="<?php echo e(route('projects-siyakha')); ?>">SIYAKHA - TA</a>
                    </h1>
                    <hr>
                    ...
                    <br>
                    <a href="<?php echo e(route('projects-siyakha')); ?>" class="text-cyan-700 hover:font-bold hover:text-cyan-900">Read
                        More ></a>
                </div>
            </div>
        </div>
                  ...
                  <div>
                    <div
                      ...
                      <div
                        ...
                        <img
                          src="<?php echo e(URL::to('/assets/img/voices.jpg')); ?>" />
                      </div>
                      <div class="p-6">
                  ...
                  <div>
                    <div
                      ...
                      <div
                        class="mx-auto -mt-12 w-24 overflow-hidden rounded-full border-2 border-white bg-white dark:border-neutral-800 dark:bg-neutral-800">
                        <img
                          src="<?php echo e(URL::to('/assets/img/bongani.jpeg')); ?>" />
                      </div>
                      <div class="p-6">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\L\Documents\Projects\Laravel Projects\bz-web-final-laravel-project\resources\views/projects/index.blade.php ENDPATH**/ ?>