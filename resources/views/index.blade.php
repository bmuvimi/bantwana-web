...
@section('content')
            ...
            <div class="relative h-56 overflow-hidden md:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <span
                        ...
                        Slide</span>
                    <img src="{{ URL::to('build/assets/slider-1.jpg') }}"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ URL::to('build/assets/slider-2.jpg') }}"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ URL::to('build/assets/slider-3.jpg') }}"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
            </div>
            <!-- Slider indicators -->
    ...
    <section class="text-center bg-orange-400 py-20 font-sans font-bold">
        ...
        <br>
        <h4 class="text-white font-thin text-2xl">Improving the wellbeing of vulnerable children, adolescents, youth, and
            their caregivers and families</h4>
        {{-- <h4 class="text-white font-thin text-2xl">Empowering Orphans and Vulnerable Children through Comprehensive Social
                Services</h4> --}}
    </section>
    ...
    <section class="bg-white pt-20 pb-15 px-5 font-sans">
        <div class="max-w-screen-md mx-auto text-center">
            <div class="pb-5">
                <h3
                    class="text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r to-cyan-800 from-orange-400">
                    Get To Know Us</h3>
    ...
    <section class="projects-section grid-cols-2 px-10 mx-auto pt-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-10 mt-20 px-10">
            ...
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                <img src="{{ URL::to('build/assets/project2.jpg') }}" class="hover:drop-shadow-lg hover:opacity-70"
                ...
                <div class="px-3 py-2">
                    ...
                    <p class="text-sm pt-5">DREAMS is a partnership committed to helping girls develop into Determined,
                        Resilient, Empowered, AIDS-Free, Mentored, and Safe women. It funds evidence-informed approaches
                        that address structural drivers that increase girls’ HIV risk such as poverty and gender inequality.
                    </p>
                    <br>
            ...
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                ...
                <div class="px-3 py-2">
                    ...
                    <p class="text-sm pt-5">Bantwana Zimbabwe (BZ) is implementing the Zingane – OVC project which aims at
                        Sustaining Prevention, Care and Support Services for OVC in Zimbabwe (SPCSS-OVC) in Bulawayo,
                        Matabeleland North, Matabeleland South, and Midlands.</p>
                    <br>
            ...
            <div class="flex flex-col bg-white drop-shadow  rounded-sm">
                ...
                <div class="px-3 py-2">
                    ...
                    <p class="text-sm pt-5">The Child Protection programme is a UNICEF-funded project designed to
                        strengthen the capacity of Zimbabwe’s child protection system to provide a coordinated response to
                        violence against children and bolster local government and community responses to COVID-19.</p>
                    <br>
                    <a href="{{ route('projects-cp') }}" class="text-cyan-700 hover:font-bold hover:text-cyan-900">Read
                        More ></a>
                </div>
            </div>
        </div>
    ...
    <section class="px-20 h-50vh mt-20 py-10">
        <div class="grid grid-cols-3 ">
            <div class="col-span-2 bg-gray-100  px-10 flex justify-center items-center">
                <div class=" ">
                    <h1 class="font-semibold text-4xl text-cyan-800"><span class="text-orange-400">Voices </span>From The
                        Field</h1>
                    <p class="pt-8 text-cyan-800 font-sans">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Commodi,
                        nam, veritatis iste quos laborum ad nobis accusantium obcaecati explicabo tenetur ut reprehenderit
                        minus
                        ducimus assumenda quas atque omnis itaque cupiditate reiciendis numquam animi? Minus, necessitatibus
                        magnam ad adipisci nulla unde. Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente
                        libero
                        voluptatem molestias explicabo, exercitationem delectus repellendus magnam dolor, nobis sint est,
                        nemo
                        repellat atque.</p>
                </div>
            </div>
            <div class="col bg-orange-400 py-30">
                <img src="{{ URL::to('build/assets/voices.jpg') }}" alt="" style"height:70vhl">
            </div>
        </div>
    </section>

    <section class="impact-section mt-16 " style="background:{{ asset('assets/img/slider-3.jpg') }}">
