              ...
              <div class="flex flex-wrap">
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                  <div class="flex items-start">
                    ...
                    <div class="grow ml-6">
                      ...
                      <p class="text-orange-600">15 Thurston Lane, Belgravia, Harare</p>
                ...
                <div class="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                  <div class="flex align-start">
                    ...
                    <div class="grow ml-6">
                      <p class="font-bold mb-1">Regional Office - Bulawayo (Zingane-OVC)</p>
                      <p class="text-orange-600">4 Laughton Road, khumalo, Bulawayo</p>
                      <p class="text-cyan-800">info@bantwana.co.zw</p>
                      <p class="text-cyan-800"> 263 8677 009776</p>
                    </div>
                  </div>
                ...
                <div class="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                  <div class="flex align-start">
                    ...
                    <div class="grow ml-6">
                      <p class="font-bold mb-1">District office - Kwekwe</p>
                      <p class="text-orange-600">2 Central Avenue, Kwekwe</p>
                      <p class="text-cyan-800">info@bantwana.co.zw</p>
                      <p class="text-cyan-800"> 263 8677 009776</p>
                    </div>
                  </div>
      ...
      <section class="mb-32 text-gray-600">
          <div class="flex flex-wrap">
              <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
                  ...
                  <p class="text-gray-600 mb-2">15 Thurston Lane, Belgravia, Harare</p>
                  <p class="text-gray-600 mb-2">+263 8677 009776</p>
        ...
        "
                      ...
                      <div class="form-group form-check text-center mb-6">
                          <input type="checkbox"
                              class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
                              id="exampleCheck87" checked>
                          <label class="form-check-label inline-block text-gray-800" for="exampleCheck87">Are you a Donor, please tick this
                              box</label>
                      </div>
                      <button type="submit"
                          class="
